    ...
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                ...
                "scene" => scene = <i32>::deserialize(deserializer),
...
impl<'a> Deserialize<'a> for Texture {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "sampler" => sampler = <i32>::deserialize(deserializer),
                "source" => source = <i32>::deserialize(deserializer),
...
impl<'a> Deserialize<'a> for Skin {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "inverseBindMatrices" => inverse_bind_matrices = <i32>::deserialize(deserializer),
                "skeleton" => skeleton = <i32>::deserialize(deserializer),
                "joints" => joints = <Vec<i32>>::deserialize(deserializer),
                "name" => name = <String>::deserialize(deserializer),
                "extensions" => extensions = <Extension>::deserialize(deserializer),
                _ => {}
            }
...
impl<'a> Deserialize<'a> for Scene {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "nodes" => nodes = <Vec<i32>>::deserialize(deserializer),
                "name" => name = <String>::deserialize(deserializer),
                "extensions" => extensions = <Extension>::deserialize(deserializer),
                _ => {}
            }
...
impl<'a> Deserialize<'a> for Node {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "camera" => camera = <i32>::deserialize(deserializer),
                "children" => children = <Vec<i32>>::deserialize(deserializer),
                "skin" => skin = <i32>::deserialize(deserializer),
                "matrix" => matrix = <[f32; 16]>::deserialize(deserializer),
                "mesh" => mesh = <i32>::deserialize(deserializer),
...
pub struct MeshPrimitive {
    ...
    pub targets: Option<Vec<HashMap<String, i32>>>,
    /// Dictionary object with extension-specific objects.
    pub extensions: Option<Extension>,
}
...
impl<'a> Deserialize<'a> for MeshPrimitive {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "attributes" => attributes = <HashMap<String, i32>>::deserialize(deserializer),
                "indices" => indices = <i32>::deserialize(deserializer),
                "material" => material = <i32>::deserialize(deserializer),
                "mode" => mode = <MeshPrimitiveMode>::deserialize(deserializer),
                "targets" => targets = <Vec<HashMap<String, i32>>>::deserialize(deserializer),
                "extensions" => extensions = <Extension>::deserialize(deserializer),
                _ => {}
            }
        }
...
impl<'a> Deserialize<'a> for MaterialOcclusionTextureInfo {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "index" => index = <i32>::deserialize(deserializer),
                "texCoord" => tex_coord = <i32>::deserialize(deserializer),
    ...
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                ...
                "bufferView" => buffer_view = <i32>::deserialize(deserializer),
                "name" => name = <String>::deserialize(deserializer),
                "extensions" => extensions = <Extension>::deserialize(deserializer),
                _ => {}
            }
...
impl<'a> Deserialize<'a> for BufferView {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "buffer" => buffer = <i32>::deserialize(deserializer),
                "byteOffset" => byte_offset = <i32>::deserialize(deserializer),
                "byteLength" => byte_length = <i32>::deserialize(deserializer),
                "byteStride" => byte_stride = <i32>::deserialize(deserializer),
...
impl<'a> Deserialize<'a> for AnimationSampler {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "input" => input = <i32>::deserialize(deserializer),
                "interpolation" => {
                    interpolation = <AnimationSamplerInterpolation>::deserialize(deserializer)
                }
                "output" => output = <i32>::deserialize(deserializer),
                "extensions" => extensions = <Extension>::deserialize(deserializer),
                _ => {}
            }
        }
...
impl<'a> Deserialize<'a> for AnimationChannelTarget {
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                "node" => node = <i32>::deserialize(deserializer),
    ...
    fn deserialize<D: Deserializer<'a>>(deserializer: &mut D) -> Option<Self> {
        ...
        while let Some(property) = deserializer.has_property() {
            match &*property {
                ...
                "count" => count = <i32>::deserialize(deserializer),
